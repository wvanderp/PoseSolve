...
async function ensureWasm() {
  ...
  // TypeScript can't resolve this Vite-served absolute path at build time.
  // @ts-ignore: TS can't find the generated wasm-pack module in the repo until it's built
